...
version "12.18.3" "12.22.6" {
}

version "14.16.0" "14.17.0" "14.17.3" "16.9.0" "14.18.0" {
  auto-version {
...
version "16.1.0" "16.2.0" "16.3.0" "16.4.0" "16.5.0" "16.6.0" "16.6.1" "16.6.2" "16.7.0" "16.8.0" "16.9.1" "16.10.0" {
  darwin {
    arch = "arm64"
